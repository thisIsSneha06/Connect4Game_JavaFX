...
import com.example.connect4game.Controller;
...
public class Main extends Application
{
	...
	private void aboutMe()
	{
		...
		alert.setHeaderText("Sneha Tiwari");
		alert.setContentText("Hi! I am Sneha, a developer focused on crafting" +
				...
				" My other hobbies includes Photography, Cooking & Organizing.");
